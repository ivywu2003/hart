...
namespace {
    void nvte_fused_rope_with_pos_forward_metal(const at::Tensor input, const at::Tensor freqs,
        ...
        auto pipelineState = library.newComputePipelineState(withFunction: "fused_rope_with_pos_forward");
        ...
        computeEncoder.setBytes(&s, length: sizeof(int), index: 10);
...
at::Tensor fused_rope_with_pos_forward_metal(const at::Tensor &input,
    ...
    nvte_fused_rope_with_pos_forward_metal(input, freqs, output, s, b, h, d, d2,
